...
> Уровень подготовки определяется с помощью нашего приложения, которое за несколько вопросов определяет знания участника. В отдельных случаях участники {SСС} будут проводить собеседование.
